...
public class Polygon
{
    ...
    public static class Builder
    {
        ...
        public boolean buildWitchoutClose(){
        ...
        {
            android.util.Log.d("WritePoligonsToDate", "!!!!!!!!!!!!!!!!! DEBUG  AMMOUMT of vertexes="+_vertexes.size()+"");
            if (_vertexes.size() < 1)
            {

                throw new RuntimeException("Polygon must have at least 1 point");
            }
        }
    }
