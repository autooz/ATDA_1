...
/**
 * Asynchronous processing of the event, the event handler in the sub-thread execution
 *
 * @author mrsimple
 */
public class AsyncEventHandler implements EventHandler {
    ...
    /**
     * The subscription function performs asynchronous thread
     *
     * @param subscription
     * @param event
     */
    ...
    class DispatcherThread extends HandlerThread {
        ...
        /**
         * AsyncExecutor message queue associated with Handler
         */
